...
func appengineTemplateRootHtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "appengine/template/root.html", size: 476, mode: os.FileMode(0664), modTime: time.Unix(1588572929, 0)}
...
func appengineTemplateUHtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "appengine/template/u.html", size: 464, mode: os.FileMode(0664), modTime: time.Unix(1588572929, 0)}
