...
func appengineTemplateFsSnippetTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "appengine/template/fs-snippet.tmpl", size: 1124, mode: os.FileMode(0664), modTime: time.Unix(1586880158, 0)}
...
func appengineTemplateRootTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "appengine/template/root.tmpl", size: 370, mode: os.FileMode(0664), modTime: time.Unix(1586880158, 0)}
...
func appengineTemplateUTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "appengine/template/u.tmpl", size: 568, mode: os.FileMode(0664), modTime: time.Unix(1586880158, 0)}
